    ...
    extend: {
      ...
      keyframes: {
        "neon-pulse": {
          ...
          "50%": { 
            textShadow: "0 0 20px rgba(6, 182, 212, 1), 0 0 30px rgba(6, 182, 212, 0.8), 0 0 40px rgba(6, 182, 212, 0.6)",
      ...
      boxShadow: {
        ...
        "neon-magenta": "0 0 5px rgba(236, 72, 153, 0.5), 0 0 10px rgba(236, 72, 153, 0.3), 0 0 15px rgba(236, 72, 153, 0.2)",
        "neon-purple": "0 0 5px rgba(168, 85, 247, 0.5), 0 0 10px rgba(168, 85, 247, 0.3), 0 0 15px rgba(168, 85, 247, 0.2)",
      },
    },
  },
